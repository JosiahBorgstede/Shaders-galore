...
void Renderer::Render(){
    ...
    {
        m_framebuffers[0]->m_fboShader->SetUniform1i("depth_debug", 0);
    }
    else if(currentKeyStates[ SDL_SCANCODE_1])
    {
        m_framebuffers[0]->m_fboShader->SetUniform1i("depth_debug", 1);
    }
    else if(currentKeyStates[ SDL_SCANCODE_2])
    {
        m_framebuffers[0]->m_fboShader->SetUniform1i("depth_debug", 2);
    }
    else if(currentKeyStates[ SDL_SCANCODE_3])
    {
        m_framebuffers[0]->m_fboShader->SetUniform1i("depth_debug", 3);
    }
    else if(currentKeyStates[ SDL_SCANCODE_4])
    {
        m_framebuffers[0]->m_fboShader->SetUniform1i("depth_debug", 4);
    }
    else if(currentKeyStates[ SDL_SCANCODE_5])
    {
        m_framebuffers[0]->m_fboShader->SetUniform1i("depth_debug", 5);
    }
    else if(currentKeyStates[ SDL_SCANCODE_6])
    {
        m_framebuffers[0]->m_fboShader->SetUniform1i("depth_debug", 6);
    }
    else{
