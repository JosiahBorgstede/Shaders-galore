...
void Geometry::MakeTriangle(unsigned int vert0, unsigned int vert1, unsigned int vert2){
	...
	glm::vec3 calcNorm = glm::cross(edge0, edge1);
	m_normals[vert0*3+0] = calcNorm.x;	m_normals[vert0*3+1] = calcNorm.y;	m_normals[vert0*3+2] = calcNorm.z;	
	m_normals[vert1*3+0] = calcNorm.x;	m_normals[vert1*3+1] = calcNorm.y;	m_normals[vert1*3+2] = calcNorm.z;	
	m_normals[vert2*3+0] = calcNorm.x;	m_normals[vert2*3+1] = calcNorm.y;	m_normals[vert2*3+2] = calcNorm.z;	
